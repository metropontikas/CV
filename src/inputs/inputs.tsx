...
const workExperience = [
  ...
  },
  {
    ...
    isPresent: false,
    styledContent:
      "Decided to switch careers and jump into web development after failing to find exciting challenges at work.\n\nLearned HTML, CSS, JavaScript through online courses.",
  },
  {
    title: "Caregiver",
    dateStart: "05/2020",
  ...
  },
  {
    ...
    styledContent:
      "Responsible for organising and facilitating the everyday life of 12 to 18 underage beneficiaries, age 4 to 18, of mixed origins.\nWorked constantly under pressure, learnt to think creatively, while keeping the quality of work.",
